...
export const ALL_SKILLS: SkillDefinition[] = [
  ...
  { key: 'skulduggery', nameDE: 'Infiltration', description: 'Schlösser knacken, Taschen leeren, Fesseln lösen. Die Kunst der geschickten Finger.', characteristic: 'cunning', category: 'general' },
  ...
  { key: 'streetwise', nameDE: 'Straßenwissen', description: 'Schwarzmarkt-Kontakte, Gerüchte, Informanten. Du weißt, wen man in welcher Cantina fragt.', characteristic: 'cunning', category: 'general' },
  ...
  { key: 'vigilance', nameDE: 'Wachsamkeit', description: 'Instinktive Wachsamkeit. Bestimmt deine Initiative, wenn der Kampf dich überrascht.', characteristic: 'willpower', category: 'general' },
  // Combat Skills
